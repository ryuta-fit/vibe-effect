    ...
    creator: () => `
        <div class="creator-card-demo">
            ...
            <div class="creator-card-info">
                ...
                <p class="creator-card-title">百歳製造所代表<br>整体師/トレーナー<br>バイブコーダー</p>
                <div class="creator-card-links">
                    <a href="https://twitter.com/ryuta_fit" target="_blank" rel="noopener noreferrer" class="creator-card-link">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                        </svg>
                    </a>
                    <a href="https://instagram.com/ryuta_fit" target="_blank" rel="noopener noreferrer" class="creator-card-link">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
